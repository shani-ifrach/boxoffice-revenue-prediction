...
KPI display and model-evaluation interactions. Programmatic verification checks
ZIP/XML integrity and analytical key/title relationships. Dashboard layouts,
filters and tooltips require visual verification in Tableau.

The final workbook and active CSVs were preserved during code changes. Revenue
predictions, evaluation metrics, classifier thresholds and interval widths were
